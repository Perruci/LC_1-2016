...
Verbose proof for {\tt func\_eqQB}.
...
Instantiating the top quantifier in -1 with the terms: 
 \pvsid{quick\_sort}\pvsid{(}\(l\)\pvsid{)}, \pvsid{bubblesort}\pvsid{(}\(l\)\pvsid{)},
...
Instantiating the top quantifier in -1 with the terms: 
 \pvsid{quick\_sort}\pvsid{(}\(l\)\pvsid{)}, \(l\), \pvsid{bubblesort}\pvsid{(}\(l\)\pvsid{)},
